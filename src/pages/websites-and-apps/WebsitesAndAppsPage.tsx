/** Websites and Apps listing — search + Add new + table (sites moved off the left rail).
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="min-w-0 max-w-xl space-y-1">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            View details of and manage all websites, mobile apps and server-side
            projects you have added to Wingify.
          </p>
        </div>
