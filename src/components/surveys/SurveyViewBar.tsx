...
import {
  SURVEY_LAYOUT_LABEL as LAYOUT_LABEL,
  SURVEY_OVERVIEW_ID as OVERVIEW_ID,
  isSurveyDirtyIgnoringLayout as isDirtyIgnoringLayout,
  useIsActiveSurveyViewDirty as useIsActiveViewDirty,
  useIsActiveSurveyViewUnsaved as useIsActiveViewUnsaved,
  useSurveyViewsStore as useViewsStore,
  type SurveyLayout as Layout,
...
export default function SurveyViewBar() {
