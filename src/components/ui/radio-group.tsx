  ...
  return (
    ...
    >
      <RadioGroupPrimitive.Indicator className="flex h-full w-full items-center justify-center">
        ...
        <span
          aria-hidden
          className="block h-1.5 w-1.5 rounded-full bg-[hsl(var(--appearance-radio-dot,_var(--appearance-radio-selected-text,_var(--control-selected-fg,_var(--control-foreground)))))]"
        />
