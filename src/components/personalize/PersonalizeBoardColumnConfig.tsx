...
import {
  ...
  type PersonalizeBoardColumnConfig as BoardColumnCfg,
} from "../../store/personalizeViews";
import type { PersonalizeGroupField } from "../../config/personalizeGrouping";
import { cn } from "../../lib/utils";
import { arrangeKeys, naturalKeys } from "./personalizeBoardColumns";

const CHECKBOX_CLASS =
  "h-3.5 w-3.5 [&_svg]:size-3 disabled:cursor-not-allowed";

export default function PersonalizeBoardColumnConfig() {
  const { groupBy, boardColumns } = useActivePersonalizeViewState();
