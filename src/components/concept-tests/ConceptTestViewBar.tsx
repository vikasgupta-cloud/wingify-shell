...
import {
  CONCEPT_TEST_LAYOUT_LABEL as LAYOUT_LABEL,
  CONCEPT_TEST_OVERVIEW_ID as OVERVIEW_ID,
  isConceptTestDirtyIgnoringLayout as isDirtyIgnoringLayout,
  useIsActiveConceptTestViewDirty as useIsActiveViewDirty,
  useIsActiveConceptTestViewUnsaved as useIsActiveViewUnsaved,
  useConceptTestViewsStore as useViewsStore,
  type ConceptTestLayout as Layout,
...
export default function ConceptTestViewBar() {
